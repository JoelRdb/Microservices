...
namespace Discount.Infrastructure.Extensions
{
    ...
    {
        public static IHost MigrateDatabse<TContext>(this IHost host)
        {
        ...
        private static void ApplyMigrations(IConfiguration config)
        {
            ...
            cmd.CommandText = "INSERT INTO Coupon(ProductName, Dscription, Amount)VALUES('Adidas Quick Force Indoor Badminton Shoes', 'Shoes Discount', 500)";
            cmd.ExecuteNonQuery();
